...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6315836859 5840622348 6067718572 5023815012 6441914464').split()]
...
# Others
S_GROUP = environ.get('S_GROUP',"https://t.me/filims_18")
TMP_DOWNLOAD_DIRECTORY = environ.get("TMP_DOWNLOAD_DIRECTORY", "./DOWNLOADS/")
CHANNEL_ID = environ.get("CHANNEL_ID", "-1001934416640")
CHANNEL_LINK = environ.get('CHANNEL_LINK', 'https://t.me/+-tu7uU2CVmgwYmI1')
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+bwQCJI99tWA4ODM1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/filims_18')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '+bwQCJI99tWA4ODM1')
